package com.learning.springsecurity.oauth.test;
...
import com.learning.springsecurity.oauth.model.AuthTokenInfo;
import com.learning.springsecurity.oauth.model.User;
 
public class SpringRestClient {
 
    public static final String REST_SERVICE_URI = "http://localhost:8080/UserManagement";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/UserManagement/oauth/token";
