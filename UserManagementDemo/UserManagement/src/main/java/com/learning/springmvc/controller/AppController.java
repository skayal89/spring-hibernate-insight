 ...
 * 
 * what is the proper way to obtain current username?
...
public class AppController {
    ...
    public String listUsers(ModelMap model) {
    	logger.info("AppController//list executing");
    ...
    public List<UserRole> initializeRoles() {
    	...
    	logger.info("AppController/init roles: {}",roles);
        return roles;
    }
    ...
    public String loginPage() {
    	logger.info("AppController/Login/Anonymous: "+isCurrentAuthenticationAnonymous());
    ...
    private String getPrincipal(){
        ...
        logger.info("AppController/getPrincipal/"+userName);
        return userName;
    }
